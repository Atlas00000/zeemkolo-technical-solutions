/**
 * Static / driven library atmosphere — wash, grid, shear.
 * No watermark, no zip sweep. Used by LibraryField and course/lesson desks.
 */
export function LibraryAtmosphere({
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `
            ...
            radial-gradient(
              ellipse 38% 42% at 10% 88%,
              color-mix(in srgb, var(--ln-mark) 9%, transparent),
              transparent 55%
            ),
            linear-gradient(
              152deg,
              ...
              var(--ln-canvas) 40%,
              color-mix(in srgb, var(--ln-signal) 10%, var(--ln-canvas)) 100%
            )
          `,
      ...
      <div
        className="absolute -inset-[8%] opacity-[0.36] dark:opacity-[0.24]"
        style={{
          backgroundImage: `
          ...
          maskImage:
            "radial-gradient(ellipse 72% 68% at 72% 32%, black 16%, transparent 72%)",
        }}
      />

      <div
        className="absolute -right-[12%] top-[-18%] h-[140%] w-[52%] origin-top-right skew-x-[-11deg] opacity-45"
        style={{
