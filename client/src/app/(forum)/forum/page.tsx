...
export default async function ForumPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-16">
      ...
      <h1 className="mt-3 font-display text-4xl text-brand-ink">Zeemble forum</h1>
      ...
      {error ? (
        ...
        <>
          ...
          <section className="mt-12">
            <h2 className="font-display text-2xl text-brand-ink">Recent threads</h2>
            <div className="mt-2">
              {threads.length === 0 ? (
                <p className="mt-4 text-brand-steel">No threads yet.</p>
              ) : (
